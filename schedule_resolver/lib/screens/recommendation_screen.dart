        ...
        body: SingleChildScrollView(
          ...
          child: Column(
            children: [
              ...
              const SizedBox(height: 16,),
              _buildSection(context, 'Recommend Schedule', analysis.recommendedSchedule, Colors.green.shade100, Icons.calendar_today),
              const SizedBox(height: 16,),
              _buildSection(context, 'Explanation', analysis.explanation, Colors.red.shade100, Icons.lightbulb_outlined),
            ],
        )
      ),
    );
